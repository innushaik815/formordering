...
const tableRowHtml = `
  <tr class="tablerow">
    ...
    <td><input type="number" id="itemprice" disabled></td>
    <td><input type="number" id="itemquantity"></td>
    <td><input type="number" id="totalitemprice" disabled ></td>
  </tr>
`;
...
plusButton.addEventListener('click', function () {
  ...
  const itemNameSelect = newRow.querySelector('#itemname');
  const itemSizeSelect = newRow.querySelector('#itemsize');
  const itemPriceInput = newRow.querySelector('#itemprice');
  const itemQuantityInput = newRow.querySelector('#itemquantity');
  const totalItemPriceInput = newRow.querySelector('#totalitemprice');
  ...
  categorySelect.addEventListener('change', (event) => {
    ...
    switch (category) {
      case 'pizza':
        ...
        `;
        itemPriceInput.value = '';
        itemSizeSelect.style.display = 'block';
        break;
      case 'beverages':
        itemNameSelect.innerHTML = `
        ...
        `;
        itemPriceInput.value = '';
        itemSizeSelect.style.display = 'none';
        break;
      case 'garlic-bread':
        itemNameSelect.innerHTML = `
          <option value="">Garlic Bread</option>
        `;
        itemPriceInput.value = 4;
        itemSizeSelect.style.display = 'none';
        break;
      default:
        itemNameSelect.innerHTML = `
